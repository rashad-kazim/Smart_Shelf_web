...
export const appTranslations = {
  en: {
    ...
    // --- YENİ EKLENEN LOADER BÖLÜMÜ ---
    loader: {
      loadingTitle: "Loading...",
    },
    // --- YENİ EKLENEN DİALOG BÖLÜMÜ ---
    dialogs: {
      confirmTitle: "Confirm Action",
      confirmMessage: "Are you sure you want to proceed?",
      deleteConfirmationPrompt: "To confirm, please type:",
      deleteConfirmationMismatch:
        "The entered text does not match. Action cancelled.",
      yesButton: "Yes",
      noButton: "No",
      okButton: "OK",
    },
    ...
    users: {
      ...
      // AddCompanyUserForm Sayfası için
      addUserForm: {
        ...
        genericError: "An error occurred while creating the user.",
      },

      // EditCompanyUserForm Sayfası için
      editUserForm: {
        title: "Edit User",
  ...
  tr: {
    ...
    dialogs: {
      ...
      confirmMessage: "Devam etmek istediğinizden emin misiniz?",
      deleteConfirmationPrompt: "Onaylamak için lütfen yazın:",
      deleteConfirmationMismatch:
        "Girilen metin uyuşmuyor. İşlem iptal edildi.",
      yesButton: "Evet",
      noButton: "Hayır",
      okButton: "Tamam",
    },
    ...
    users: {
      ...
      // AddCompanyUserForm Sayfası için
      addUserForm: {
        title: "Yeni Şirket Çalışanı Ekle",
        subtitle:
          "Yeni bir kullanıcı hesabı oluşturmak için detayları doldurun.",
        nameLabel: "Ad",
        surnameLabel: "Soyad",
        emailLabel: "E-posta",
        passwordLabel: "Şifre",
        ...
        countryLabel: "Ülke",
        countryPlaceholder: "Bir ülke arayın...",
        cityLabel: "Şehir",
        cityPlaceholder: "Bir şehir arayın...",
        ...
        genericError: "Kullanıcı oluşturulurken bir hata oluştu.",
      },

      // EditCompanyUserForm Sayfası için
      editUserForm: {
        title: "Kullanıcıyı Düzenle",
        subtitlePrefix: "Şu kullanıcının detaylarını güncelle:",
      ...
      confirmDeleteTitle: "Kullanıcı Silmeyi Onayla",
      confirmDeleteMessage: "Kullanıcıyı silmek istediğinizden emin misiniz?",
    },
    firmware: {
  ...
  az: {
    ...
    users: {
      ...
      // CompanyUsers Səhifəsi üçün
      companyUsersPage: {
        title: "Şirkət İşçiləri",
        subtitle: "İdarəçiləri, ölkə məsullarını və mühəndisləri idarə edin",
        addUser: "İstifadəçi Əlavə Et",
      },

      // AddCompanyUserForm Səhifəsi üçün
      addUserForm: {
        title: "Yeni Şirkət İşçisi Əlavə Et",
        subtitle:
          "Yeni bir istifadəçi hesabı yaratmaq üçün məlumatları doldurun.",
        nameLabel: "Ad",
        surnameLabel: "Soyad",
        emailLabel: "E-poçt",
        passwordLabel: "Şifrə",
        ...
        selectRole: "Bir rol seçin",
        countryLabel: "Ölkə",
        countryPlaceholder: "Ölkə axtarın...",
        cityLabel: "Şəhər",
        cityPlaceholder: "Şəhər axtarın...",
        ...
        genericError: "İstifadəçi yaradılarkən bir xəta baş verdi.",
      },

      // EditCompanyUserForm Səhifəsi üçün
      editUserForm: {
        title: "İstifadəçini Dəyiş",
        subtitlePrefix: "Bu istifadəçinin məlumatlarını yenilə:", // Örn: "Bu istifadəçinin məlumatlarını yenilə: Rasad Kazimov"
        nameLabel: "Ad",
        surnameLabel: "Soyad",
        emailLabel: "E-poçt",
        roleLabel: "Rol",
      ...
      // Dialoq və Ümumi Mətnlər
      noUsersFound: "İstifadəçi tapılmadı.",
      confirmDeleteTitle: "İstifadəçi Silinməsini Təsdiq Edin",
      confirmDeleteMessage: "İstifadəçini silmək istədiyinizə əminsinizmi?",
    },
    firmware: {
  ...
  ru: {
    ...
    users: {
      ...
      userForSupermarketDesc:
        "Управление пользователями, связанными с филиалами супермаркетов.",
      userForCompanyTitle: "Сотрудники Компании",
      userForCompanyDesc:
      ...
      addUserForm: {
        ...
        genericError: "Произошла ошибка при создании пользователя.",
      },

      // EditCompanyUserForm Sayfası için
      editUserForm: {
        title: "Редактировать Пользователя",
        subtitlePrefix: "Обновить данные для", // Örn: "Обновить данные для John Doe"
        nameLabel: "Имя",
        surnameLabel: "Фамилия",
        emailLabel: "Эл. почта",
        roleLabel: "Роль",
      ...
      countryHeader: "Страна",
      cityHeader: "Город",
      assignedStoreHeader: "Назначенный Магазин",

      // Dialog ve Genel Metinler
      noUsersFound: "Пользователи не найдены.",
      confirmDeleteTitle: "Подтвердить Удаление Пользователя",
  ...
  pl: {
    ...
    users: {
      ...
      userForSupermarketDesc:
        "Zarządzaj użytkownikami przypisanymi do oddziałów supermarketów.",
      userForCompanyTitle: "Pracownik Firmy",
      userForCompanyDesc:
        "Zarządzaj użytkownikami przypisanymi do głównej firmy.",
      ...
      // AddCompanyUserForm Sayfası için
      addUserForm: {
        title: "Dodaj Nowego Pracownika Firmy",
        subtitle: "Wypełnij dane, aby utworzyć nowe konto użytkownika.",
        nameLabel: "Imię",
        ...
        cityLabel: "Miasto",
        cityPlaceholder: "Wyszukaj miasto...",
        saveButton: "Zapisz Użytkownika",
        cancel: "Anuluj",
        passwordMismatchError: "Hasła nie są zgodne.",
        roleRequiredError: "Proszę wybrać rolę dla użytkownika.",
        genericError: "Wystąpił błąd podczas tworzenia użytkownika.",
      },

      // EditCompanyUserForm Sayfası için
      editUserForm: {
        title: "Edytuj Użytkownika",
        subtitlePrefix: "Zaktualizuj dane dla", // Örn: "Zaktualizuj dane dla Jan Kowalski"
        nameLabel: "Imię",
        surnameLabel: "Nazwisko",
        emailLabel: "E-mail",
        roleLabel: "Rola",
