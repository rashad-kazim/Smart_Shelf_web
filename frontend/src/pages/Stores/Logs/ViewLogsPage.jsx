  ...
  return (
    <div
      ...
      <h1 className="text-3xl font-semibold mb-6">
        {translations.viewLogsTitle || "View Logs"}
      </h1>
        ...
        <div className="relative" ref={countryInputRef}>
          ...
          <div className="relative">
            <input
              ...
              // FIX: Style is set conditionally based on isAdmin status
              style={
                !isAdmin
                  ? {
                      // If not admin (disabled state)
