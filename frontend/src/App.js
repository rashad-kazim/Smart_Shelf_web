...
function DeleteStorePage({
  ...
  const handleDeleteStore = (storeToDelete) => {
    ...
    setDialogMessage(
      `<span class="math-inline">\{translations\.confirmDeleteMessage\} '</span>{storeToDelete.name}'?`
    );
  ...
  const hoursOptions = useMemo(() => {
    ...
    for (let i = 0; i < 24; i++) {
      for (let m = 0; m < 60; m += 30) {
        ...
        hours.push(`<span class="math-inline">\{hour\}\:</span>{minute}`);
      }
    }
    return hours;
  }, []);
          ...
          store.id === editableStoreForm.id
            ? {
                ...
                working_hours: editableStoreForm.allDayOpen
                  ? "24/7"
                  : `<span class="math-inline">\{editableStoreForm\.openingHour\}\-</span>{editableStoreForm.closingHour}`,
              }
            : store
        );
...
function ESP32LogsPage({
  ...
  }, [installedDevices, selectedStoreForLogs.id, thirtyDaysAgo, today]);
...
function App() {
  ...
  const logoPlaceholderUrl = `https://placehold.co/180x40/<span class="math-inline">\{currentColors\.headerSidebarBg\.substring\(1\)\}/</span>{currentColors.logoPrimaryBlue.substring(1)}?font=inter&text=EilSense.io`;
  ...
  const handleSaveDevice = useCallback(() => {
    ...
    setDialogType,
    setDialogCallback,
    appTranslations.en.stores.bluetoothNoDeviceSelected,
    appTranslations.en.stores.requiredFieldWarning,
    appTranslations.en.stores.invalidID,
    appTranslations.en.stores.deviceIdExists,
    deviceForm.allDayWork,
    deviceForm.id,
    deviceForm.screenSize,
    installedDevices,
    setDeviceFormErrors,
    setInstalledDevices,
    setIsDeviceFormActive,
      ...
      setStores((prevStores) => [
        ...prevStores,
        {
          ...
          working_hours: storeForm.allDayOpen
            ? "24/7"
            : `<span class="math-inline">\{storeForm\.openingHour\}\-</span>{storeForm.closingHour}`,
    ...
    if (activeRoute === "/") {
      ...
      return (
        <NewInstallationPage
          ...
          handleGenerateServerToken={handleGenerateServerToken}
          handleCheckConnection={handleCheckConnection}
          handleGenerateEsp32 // App.js (Continued)
          handleGenerateEsp32Token={handleGenerateEsp32Token}
          handleBluetoothConnect={handleBluetoothConnect}
          handleSaveDevice={handleSaveDevice}
          handleRemoveDevice={handleRemoveDevice}
